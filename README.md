...
Требования:
1. Админ панель с возможность гибких настроек компонент и их конфигураций: БД, LLM итд.
2. Админ панель для загрузки и обработки документов
3. Пользовательское окно взаимодествия с поиском: отправить запрос, получить ответ страницу с релевантным документом, получить ответ на вопрос с использованием RAG.
